...
const EquipamientoEppOtros = ({ onNext, onPrevious, data }) => {
  const [stepData, setStepData] = useState({
    esclavina: data.esclavina || '',
    linterna: data.linterna || '',
    antiparra: data.antiparra || '',
    cascoForestal: data.cascoForestal || '',
    mascaraPolvo: data.mascaraPolvo || '',
    mascaraMediaCara: data.mascaraMediaCara || '',
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2>Cuarta Sección: Equipamiento EPP</h2>
...
export default EquipamientoEppOtros;